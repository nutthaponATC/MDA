...
<body>
	...
	<div id="popupTeacherLent" class="overlay">
		<form name="formLent" action="lent_mda_teacher_process.php" method="POST">
			<div class="popup">
				<div style="font-size:30px;">รายการที่ต้องการยืม</div>
				<a class="close" href="#">&times;</a>
				<div class="content">
	...
	<div id="popupTeacherReturn" class="overlay">
		<form name="form3" action="return_mda_teacher_process.php" method="POST">
			<div class="popup">
				<div style="font-size:30px;">รายการที่ต้องการคืน</div>
				<a class="close" href="#">&times;</a>
				<div class="content">
	...
	<div id="popupManagerLent" class="overlay">
		<form name="formLent" action="lent_mda_manager_process.php" method="POST">
			<div class="popup">
				<div style="font-size:30px;">รายการที่ต้องการยืม</div>
				<a class="close" href="#">&times;</a>
				<div class="content">
	...
	<div id="popupManagerReturn" class="overlay">
		<form name="form3" action="return_mda_manager_process.php" method="POST">
			<div class="popup">
				<div style="font-size:30px;">รายการที่ต้องการคืน</div>
				<a class="close" href="#">&times;</a>
				<div class="content">
	...
	<div id="popupAdminLent" class="overlay">
		<form name="formLent" action="lent_mda_admin_process.php" method="POST">
			<div class="popup">
				<div style="font-size:30px;">รายการที่ต้องการยืม</div>
				<a class="close" href="#">&times;</a>
				<div class="content">
	...
	<div id="popupAdminReturn" class="overlay">
		<form name="form3" action="return_mda_admin_process.php" method="POST">
			<div class="popup">
				<div style="font-size:30px;">รายการที่ต้องการคืน</div>
				<a class="close" href="#">&times;</a>
				<div class="content">
