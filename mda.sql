...
INSERT INTO `data_mda` VALUES (1, 'ATS-56-02-001-01/02', 2, 2556, 'ตู้คอนเทนเนอร์', '-', 2, 70000.00, 140000.00, 'รั้วหน้าโรงเรียน', '-', '15 Nov 56', '-', '-', '-', '-', '-', '', 1);
...
INSERT INTO `data_mda` VALUES (23, 'ATS-56-04-001-01/04', 4, 2556, 'เครื่องปรับอากาศ', 'ยี่ห้อฟูจิสึ 45400 BTU MODEL AUYA 54 L (INVERTER) 4 ทิศทาง', 4, 92500.00, 370000.00, 'ห้องอำนวยการ', '-', '13 Mar 57', 'บจก. บี พี แอร์ (คุณบุญเกียรติ์ บุญธรรมติระวุฒิ)', '12/21 สุขุมวิท 103 ซอยอุดมสุข กรุงเทพ', '02 393 4831', '02 399 3015', '-', '', 1);
INSERT INTO `data_mda` VALUES (24, 'ATS-56-04-002-01/02', 4, 2556, 'เครื่องปรับอากาศ', 'ยี่ห้อ Walltype AE185A / RE185A 18399 BTU ROTARY 220V เบอร์ 5 รีโมทไร้สาย', 2, 18430.00, 36860.00, 'ห้อง ผจก. และ ผอ.', '-', '14 Mar 57', 'นายกิตติ อภัยจิตต์', '-', '080 071 9145', '-', 'Email : kservice99@gmail.com', 'Jellyfish.jpg', 1);
...
INSERT INTO `data_mda` VALUES (138, 'ats-58-02-001-01/02', 11, 2559, 'ประเภท', '-', 2, 3.00, 6.00, '-', '-', '2016-04-09', 'บริษัท', '10/90', '0806074810', '02124334', 'www', '', 0);
...
INSERT INTO `data_mda` VALUES (47, 'ATS-57-07-005-01/02', 7, 2557, 'เก้าอี้ทำงาน รหัส LG12/H', 'บุหนัง PU สีดำ MF-001+ไฮโดรลิค แขน V29', 2, 23000.00, 46000.00, 'ห้องผู้บริหาร ', '-', '27 May 57', '-', '-', '-', '-', '-', '', 1);
...
INSERT INTO `data_mda` VALUES (115, 'ATS-56- 10-001-01/01', 10, 2556, 'ซิงค์ ตู้แขวน และอุปกรณ์ติดตั้ง', '-', 1, 13000.00, 13000.00, 'ห้องเตรียมอาหาร ในสำนักงาน', 'ขาดเอกสาร', '27 Mar 57', '-', '-', '-', '-', '-', '', 1);
INSERT INTO `data_mda` VALUES (116, 'ATS-56- 10-002-01/01', 10, 2556, 'ตบแต่งภายใน (ยอดรวม 310,000 บาท)', '-', 1, 310000.00, 310000.00, 'ห้องอำนวยการ', '-', '29 Apr 57', 'สมเกียรติ รถแก้ว ', '-', '-', '-', '-', '', 1);
...
INSERT INTO `data_mda` VALUES (137, 'ATS-59-11-001-01/01', 11, 2559, 'คอมพิวเตอร์ (ชนิดตั้งโต๊ะ)', 'CPU INTEL i3 4130 Ram 4G MONITOR LED BENQ', NULL, NULL, NULL, 'ผู้จัดการ', NULL, '26 พ.ย. 2556', 'M&D COMPUTER', NULL, '02-256-0830', NULL, NULL, NULL, 1);
...
INSERT INTO `lent_return` VALUES (24, 138, 'ats-58-02-001-01/02', 'ประเภท', 3, 'Punyada', '2016-04-13', '-', '2016', 0);
...
CREATE TABLE `maintenance` (
  ...
  `date_return` varchar(50) collate utf8_unicode_ci NOT NULL,
  `company` varchar(200) collate utf8_unicode_ci NOT NULL,
  `outgoings` decimal(10,2) NOT NULL,
  `status` int(11) NOT NULL,
  PRIMARY KEY  (`id`)
...
INSERT INTO `user_mda` VALUES (1, 'admin1', 'admin1234', 'Nutthapon', 'Master IT', '2016-01-12', 2);
INSERT INTO `user_mda` VALUES (2, 'test1', '1234', 'test', 'teacher', '2016-02-17', 1);
